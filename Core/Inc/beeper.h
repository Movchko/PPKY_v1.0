...
#define BEEPER_SHORT_BEEP_DURATION     2   // Короткое пищание: 10мс (1 * 10мс)
#define BEEPER_LONG_BEEP_DURATION      100  // Длинное пищание: 1000мс (10 * 10мс)
#define BEEPER_PAUSE_DURATION          10   // Пауза между пищаниями: 100мс (1 * 10мс)
